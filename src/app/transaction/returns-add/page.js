                ...
                <Row gutter={[32]}>
                  <Col span={12}>
                    <Row gutter={[32]}>
                      <Col span={12}>
                        <Form.Item
                          ...
                          rules={[
                            {
                              required: true,
                              message: "Customer From is required",
                            },
                          ]}>
                          <Select
                            size="large"
                      ...
                      <Col span={12}>
                        <Form.Item
                          label="Plant/Customer to"
                          name="PlantCustomerTo"
                          rules={[
                            {
                              required: true,
                              message: "Plant/Customer to is required",
                            },
                          ]}>
                          <Select
                            size="large"
                            ...
                            options={[
                              {
                                value: "Plant/Customer 1",
                                label: "Plant/Customer 1",
                              },
                              {
                                value: "Plant/Customer 2",
                                label: "Plant/Customer 2",
                              },
                              {
                                value: "Plant/Customer 3",
                                label: "Plant/Customer 3",
                              },
                            ]}
                          />
                        </Form.Item>
