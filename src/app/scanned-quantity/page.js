...
export default function ScannedQuantity() {
        ...
        <Row gutter={[32, 16]} >
          <Col span={6}>
            <Card className="uidDetailLeftPanel">
              ...
              <Divider />
              <div className="mb-3">
                <Row gutter={[4]} className="pl-2">
                  <Col>
                    <EnvironmentOutlined />
                  </Col>
                  <Col>
                    <div className="key"> Without Address</div>
                    <div className="value">86,56,312</div>
                  </Col>
                </Row>
                <Row gutter={[4]} className="pl-2">
                  <Col>
                  ...
                  <Col>
                    <div className="key">With Address</div>
                    <div className="value">58,64,302</div>
                  </Col>
                </Row>
              </div>
            </Card>
...
// ScannedQuantity.getLayout = function getLayout(page) {
